...
pub fn xsend(buffer: *const u8, size: usize) {
    ecalls_module::xsend(buffer, size);
}
...
pub fn xrecv(buffer: *mut u8, max_size: usize) -> usize {
    ecalls_module::xrecv(buffer, max_size)
}
...
pub fn show_page(page_desc: *const u8, page_desc_len: usize) -> u32 {
    ecalls_module::show_page(page_desc, page_desc_len)
}
...
pub fn bn_modm(r: *mut u8, n: *const u8, len: usize, m: *const u8, len_m: usize) -> u32 {
    ecalls_module::bn_modm(r, n, len, m, len_m)
}
...
pub fn bn_addm(r: *mut u8, a: *const u8, b: *const u8, m: *const u8, len: usize) -> u32 {
    ecalls_module::bn_addm(r, a, b, m, len)
}
...
pub fn bn_subm(r: *mut u8, a: *const u8, b: *const u8, m: *const u8, len: usize) -> u32 {
    ecalls_module::bn_subm(r, a, b, m, len)
}
...
pub fn bn_multm(r: *mut u8, a: *const u8, b: *const u8, m: *const u8, len: usize) -> u32 {
    ecalls_module::bn_multm(r, a, b, m, len)
}
...
pub fn bn_powm(
    ...
    ecalls_module::bn_powm(r, a, e, len_e, m, len)
}
...
pub fn derive_hd_node(
    ...
    ecalls_module::derive_hd_node(curve, path, path_len, privkey, chain_code)
}
...
pub fn ecfp_add_point(curve: u32, r: *mut u8, p: *const u8, q: *const u8) -> u32 {
    ecalls_module::ecfp_add_point(curve, r, p, q)
}
...
pub fn ecfp_scalar_mult(curve: u32, r: *mut u8, p: *const u8, k: *const u8, k_len: usize) -> u32 {
    ecalls_module::ecfp_scalar_mult(curve, r, p, k, k_len)
}
...
pub fn get_random_bytes(buffer: *mut u8, size: usize) -> u32 {
    ecalls_module::get_random_bytes(buffer, size)
}
...
pub fn ecdsa_sign(
    ...
    ecalls_module::ecdsa_sign(curve, mode, hash_id, privkey, msg_hash, signature)
}
...
pub fn ecdsa_verify(
    ...
    ecalls_module::ecdsa_verify(curve, pubkey, msg_hash, signature, signature_len)
}
...
pub fn schnorr_sign(
    ...
    ecalls_module::schnorr_sign(
        curve, mode, hash_id, privkey, msg, msg_len, signature, entropy,
    )
}
